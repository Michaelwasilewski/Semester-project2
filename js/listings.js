      ...
      const listOfHtmlPosts = listings
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-4">
              ...
              <a href="/single-listing.html?listings_id=${post.id}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray bg-orange-300 rounded-lg hover:bg-orange-200 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-400 dark:hover:bg-orange-200 dark:focus:ring-orange-300">
              Read more
            ...
            <input type="text" id="bidding-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-300 focus:border-orange-200 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-300 dark:focus:border-orange-200" placeholder="Max 1000"/>
            <a href="" class="inline-flex items-center px-4 pt-2 text-sm font-medium text-center text-gray-600 bg-orange-300 rounded-lg hover:bg-orange-200 focus:ring-4 focus:outline-none focus:ring-orange-400 dark:bg-orange-500 dark:hover:bg-orange-400 dark:focus:ring-orange-400"">
            BID NOW
            </a>
              </div>
            </div>
