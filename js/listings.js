      ...
      const listOfHtmlPosts = listings
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
              ...
              <span class="bg-yellow-100 mb-3 text-yellow-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-orange-300 dark:text-yellow-900">${listingTags}</span>
              <span class="mb-3 bg-gray-100 text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded mr-2 dark:bg-gray-700 dark:text-gray-300">
...
<a href="/single-listing.html?listings_id=${post.id}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray bg-orange-200 rounded-lg hover:bg-orange-200 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-400 dark:hover:bg-orange-200 dark:focus:ring-blue-800">
              Read more
