...
async function getListingsById() {
  ...
  listingDetails.innerHTML = `
    ...
    <div class="flex flex-col justify-between p-4 leading-normal">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-orange-200">${description}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-orange-200">${tags}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-orange-300">Created: ${created}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-orange-300">Ends: ${endsAt}</p>
    </div>
</a>
    `;
}
